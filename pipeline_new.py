...
def fetch_data():
    ...
    if not username or not key:
        raise ValueError("KAGGLE_USERNAME or KAGGLE_KEY is not set. Check your .env file.")

    # Initialize and authenticate Kaggle API (no need to manually create kaggle.json)
    api = KaggleApi()
    api.authenticate()
